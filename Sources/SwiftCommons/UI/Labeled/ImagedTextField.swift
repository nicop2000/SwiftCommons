...
public struct ImagedTextField: View {
    ...
    public init(text: Binding<String>, systemName: String, validator: @escaping () -> Bool = { true }, required: Bool = false, keyboardType: UIKeyboardType = .default, autocapitalization: TextInputAutocapitalization = .sentences, onEditingChanged: (() -> Void)? = nil, errorText: String? = nil, normallyObscured: Bool = false, alignment: Axis.Set = .horizontal) {
        self._text = text
